...
def main():
    ...
    fig, axs = plt.subplots(1, 2, figsize=(20, 10), gridspec_kw={'wspace': 0.1, 'hspace': 0.1})
    ...
    plot_functions = [plot_med2med, plot_med2na]
    ...
    for i, (plot_func, folder_path) in enumerate(zip(plot_functions, folder_paths)):
